...
const SQUAD_TYPES = new Set(['CREATE_SQUAD', 'GET_SQUADS', 'GET_MY_SQUADS', 'INVITE_TO_SQUAD', 'LEAVE_SQUAD', 'KICK_FROM_SQUAD', 'DELETE_SQUAD', 'DETACH_SQUAD', 'GET_SQUAD_MEMBERS', 'SUBSCRIBE_SQUAD', 'SEND_SQUAD_MESSAGE', 'DELETE_SQUAD_MESSAGE', 'SQUAD_HISTORY_REQUEST']);
