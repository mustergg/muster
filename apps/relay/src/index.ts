...
console.log(`[relay]  Version: ${getCurrentVersion()} build ${getBuildNumber()} (${getGitBranch()}@${getGitCommit()})`);
...
const DM_TYPES = new Set(['SEND_DM', 'DM_HISTORY_REQUEST', 'DM_CONVERSATIONS_REQUEST', 'DELETE_DM', 'EDIT_DM']);
const ROLE_TYPES = new Set(['ASSIGN_ROLE', 'KICK_MEMBER', 'DELETE_MESSAGE', 'EDIT_MESSAGE']);
...
const SQUAD_TYPES = new Set(['CREATE_SQUAD', 'GET_SQUADS', 'GET_MY_SQUADS', 'INVITE_TO_SQUAD', 'LEAVE_SQUAD', 'KICK_FROM_SQUAD', 'DELETE_SQUAD', 'DETACH_SQUAD', 'GET_SQUAD_MEMBERS', 'SUBSCRIBE_SQUAD', 'SEND_SQUAD_MESSAGE', 'DELETE_SQUAD_MESSAGE', 'EDIT_SQUAD_MESSAGE', 'SQUAD_HISTORY_REQUEST']);
const VOICE_TYPES = new Set(['VOICE_JOIN', 'VOICE_LEAVE', 'VOICE_SIGNAL', 'VOICE_ICE_CANDIDATE', 'VOICE_MUTE', 'VOICE_ROSTER_REQUEST']);
